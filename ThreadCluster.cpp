...
__fastcall ThreadCluster::ThreadCluster(bool CreateSuspended)
...
//---------------------------------------------------------------------------
void __fastcall ThreadCluster::Execute()
{
	while(!Terminated)
	{
...
//---------------------------------------------------------------------------
void __fastcall ThreadCluster::UpdateLabel()
{
	Form1->CountResultLabel->Caption = clusters;

}

void __fastcall ThreadCluster::UpdateFS()
{
	Form1->DetectResultLabel->Caption = DetectedFS;
}

FSEnum __fastcall ThreadCluster::DetectFS(LPCWSTR device) {
...
FEEnum __fastcall ThreadCluster::GetFileType()
{
